...
//   onChangeInstruction: (id: string, newData: Partial<UIInstruction>) => void;
...
//       ? instruction.images.reduce((prev, curr) =>
...
//     return instruction.images.findIndex(
...
//           {instruction.stepNumber.toString().padStart(2, "0")}
//         </div>
...
//                         className="absolute -top-2 -right-2 p-1 rounded-full"
//                         onClick={() =>
//                           removeInstructionImage(instruction.id, index)
//                         }
//                       >
//                         <Trash2 className="w-5 h-5" />
//                       </Button>
...
//           onChange={(e) =>
//             onChangeInstruction(instruction.id, { description: e.target.value })
//           }
...
// src/components/create/SortableInstructionItem.tsx
import { Button } from "@/components/ui/button";
import { Textarea } from "@/components/ui/textarea";
import { useSortable } from "@dnd-kit/sortable";
import { CSS } from "@dnd-kit/utilities";
...
const SortableInstructionItem = ({
  ...
  // ensure there is an id at runtime (addInstruction should already provide it)
