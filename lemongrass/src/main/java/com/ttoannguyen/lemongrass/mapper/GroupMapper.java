...
public interface GroupMapper {
  ...
  @Mapping(source = "account.username", target = "ownerName")
  @Mapping(source = "account.firstName", target = "ownerFirstname")
  @Mapping(source = "account.lastName", target = "ownerLastname")
